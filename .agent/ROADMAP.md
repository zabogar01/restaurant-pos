...
| F4d | FE-025 follow-ups: per-card Clear (kitchen, checked, not audited — owner 2026-09-25) and Dismiss (receipt), three copy changes from DESIGN-008 | Not written | unassigned |
