...
| F4c | Close actually closes: *Close order & print receipt* has no handler today; a closed order leaves the book and frees its table | Not written; after F4b | unassigned |
