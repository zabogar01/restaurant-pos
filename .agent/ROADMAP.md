...
| F3 review | **Next.** The owner's single independent review of F3a–F3d, run by codex. Carry in MEMORY.md's *For the F3a–F3d review* list: the POS-03 popstate staleness, the two-store collapse, the `PinPad` seed, `/pos/floor`'s copy, and the red cases F3c never proved by mutation | Not started | — |
