...
| F5a | [FE-021](tasks/FE-021-own-items-and-quantity.md): each tile adds its own item (**fixes the live "every tile adds a Burger" bug**), and a line's quantity saves (`FR-D5`, `FR-M5`) | **Done 2026-09-24**, accepted after 5 rounds (1645 tests / 23 files). Uncommitted | `builder23` (closed) |
